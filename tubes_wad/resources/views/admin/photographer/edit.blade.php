      ...
      <div class="row">
		  ...
		  <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i></button>
				...
				<div class="card-body">
					...
					<div class="col-md-6">
						<form class="form-horizontal" action="{{ route('admin.photographer.update',$row->id) }}" method="POST" enctype="multipart/form-data">
						@csrf
						@method('PUT')
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="email" class="form-control" name="email" value="{{ old('email', $row->email) }}" readonly>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<textarea rows="3" class="form-control" name="deskripsi">{{ $row->deskripsi }}</textarea>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								<select class="form-control" name="status">
									<option value="{{$row->status}}">Pilih</option>
