      ...
      <div class="row">
		  ...
		  <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i></button>
				...
				<div class="card-body">
					...
					<div class="col-md-6">
						<form class="form-horizontal" action="{{ route('admin.layanan.store') }}" method="POST" enctype="multipart/form-data">
						@csrf
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<textarea type="text" rows="5" class="form-control" name="deskripsi" placeholder="Deskripsi Layanan"></textarea>
