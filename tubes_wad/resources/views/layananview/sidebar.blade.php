...
<aside class="main-sidebar sidebar-light-warning elevation-4">
    <!-- Brand Logo -->
    <a href="{{route('layanan.home')}}" class="brand-link">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if($class=='home'){echo "menu-open";} ?>">
            <a href="{{route('layanan.home')}}" class="nav-link <?php if($subclass=='home'){echo "active";} ?>">
          ...
          <li class="nav-item">
            <a href="{{route('layanan.order')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('layanan.gallery')}}" class="nav-link">
