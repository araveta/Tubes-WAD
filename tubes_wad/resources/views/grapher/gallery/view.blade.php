...
<div class="content-wrapper">
		...
		<div class="container-fluid">
			...
			<div class="col-sm-6">
				...
				<li class="breadcrumb-item"><a href="/grapher/gallery">Home</a></li>
          ...
          <div class="col-12">
            <div class="card card-primary">
              ...
              <div class="card-header">
                ...
                <button type="button" class="btn btn-default float-right" data-toggle="modal" data-target="#modal-default"><i class="fa fa-plus"></i> Add Foto</button>
              </div>
              <div class="card-body">
                <div class="row">
                <?php foreach($q as $k => $item): ?>
                  <div class="col-sm-2">
                    ...
                    <form action="{{ route('grapher.gallery.destroy',$item->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                      <button type="submit" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="fas fa-trash"> </i> Hapus <?= $item->nama_foto;?></button>
                    </form>
                  </div>
                  <?php endforeach ?>
                </div>
