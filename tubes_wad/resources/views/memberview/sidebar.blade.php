...
<aside class="main-sidebar sidebar-light-warning elevation-4">
    <!-- Brand Logo -->
    <a href="/memberview/front" class="brand-link">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if($class=='home'){echo "menu-open";} ?>">
            <a href="{{route('memberview.home')}}" class="nav-link <?php if($subclass=='home'){echo "active";} ?>">
          ...
          <li class="nav-item">
                <a href="/memberview/layanan" class="nav-link <?php if($subclass=='layanan'){echo "active";} ?>">
          ...
          <li class="nav-item">
            <a href="/memberview/memberorder" class="nav-link  <?php if($subclass=='order'){echo "active";} ?>">
          ...
          <li class="nav-item">
            <a href="/memberview/profile" class="nav-link <?php if($subclass=='profile'){echo "active";} ?>">
          ...
          <li class="nav-item">
            <a href="/memberview/gallery" class="nav-link  <?php if($subclass=='gallery'){echo "active";} ?>">
